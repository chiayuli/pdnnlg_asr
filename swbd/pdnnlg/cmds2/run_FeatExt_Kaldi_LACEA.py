...
from io_func.model_io_lacea import _file2nnet, log
...
if __name__ == '__main__':
    ...
    elif cfg.model_type == 'CNN_LACEA':
        model = CNN_LACEA(numpy_rng=numpy_rng, theano_rng = theano_rng, cfg = cfg, testing = True)
