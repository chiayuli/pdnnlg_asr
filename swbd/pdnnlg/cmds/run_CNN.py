...
if __name__ == '__main__':
    ...
    if os.path.exists(wdir + '/nnet.tmp_CNN') and os.path.exists(wdir + '/training_state.tmp_CNN'):
        resume_training = True
        cfg.lrate = _file2lrate(wdir + '/training_state.tmp_CNN')
        log('> ... found nnet.tmp_CNN and training_state.tmp_CNN, now resume training from epoch ' + str(cfg.lrate.epoch))
    ...
    # remove the tmp_CNN files (which have been generated from resuming training) 
    #os.remove(wdir + '/nnet.tmp_CNN')
    #os.remove(wdir + '/training_state.tmp_CNN')
