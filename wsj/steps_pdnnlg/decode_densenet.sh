...
# Decode the DenseNet model. The [srcdir] in this script should be the same as dir in
# build_nnet_pfile.sh. Also, the DenseNet model has been trained and put in srcdir.
