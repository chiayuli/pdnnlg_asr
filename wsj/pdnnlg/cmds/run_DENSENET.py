...
if __name__ == '__main__':
    ...
    if os.path.exists(wdir + '/nnet.tmp_DENSENET') and os.path.exists(wdir + '/training_state.tmp_DENSENET'):
        resume_training = True
        cfg.lrate = _file2lrate(wdir + '/training_state.tmp_DENSENET')
        log('> ... found nnet.tmp_DENSENET and training_state.tmp_DENSENET, now resume training from epoch ' + str(cfg.lrate.epoch))
    ...
    # remove the tmp_DENSENET files (which have been generated from resuming training) 
    #os.remove(wdir + '/nnet.tmp_DENSENET')
    #os.remove(wdir + '/training_state.tmp_DENSENET')
